...
class Attention(nn.Module):
    def __init__(self, args):
        ...
        self.reatten_matrix = nn.Conv2d(self.num_attention_heads, self.num_attention_heads, 1, 1)
        self.var_norm = nn.BatchNorm2d(self.num_attention_heads)
    ...
    def forward(self, hidden_states):
        ...
        # Re-attention
        attention_probs = self.var_norm(self.reatten_matrix(attention_probs)) / self.scale
